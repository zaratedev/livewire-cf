    ...
    <form class="flex items-center flex-col py-6" wire:submit.prevent="updateAvatar">
        <div class="flex items-center xl:justify-start justify-center md:flex-row flex-col">
            <div class="relative flex items-center">
                ...
                @if ($avatar)
                    <label for="absolute flex items-center flex-col justify-center text-black w-full h-full">
                    ...
                    <img src="{{ $avatar->temporaryUrl() }}" alt="" class="h-32 w-32 object-cover rounded-full flex-shrink-0 opacity-50">
                ...
                <img src="{{ auth()->user()->photo }}" id="avatar-user"
                    class="flex-shrink-0 object-cover w-32 h-32 rounded-full"
                    alt="Avatar de usuario">
                @endif
            </div>
        </div>
        <button type="submit" class="{{ $avatar ?: 'hidden'}}">Submit</button>
    </form>
